...
1.  Provide an APA citation for your selected study.
    ...
    -   Gray, G., Schalk, A., Rooney, P., & Lang, C. (2021). A Stakeholder Informed Professional Development Framework to Support Engagement with Learning Analytics. *LAK21: 11th International Learning Analytics and Knowledge Conference*. <https://doi.org/10.1145/3448139.3448162>

2.  What educational issue, "problem of practice," and/or questions were addressed?

    -   What are the constituents for a continual professional development framework based on staff and student needs?

3.  Briefly describe any steps of the data-intensive research workflow that detailed in your article or presentation.

    -   One of the referenced studies developed a 4 step workflow consisting of the following steps: Data, Process, Knowledge, Actions (Price-Dennis and Lang)
    -   Awareness, reflection, sense-making, impact (Verbert, Duval, Klerkx, Govaerts and Santos)
    -   Sensemaking and pedagogical response Wise and Jung

4.  What were the key findings or conclusions? What value, if any, might education practitioners find in these results?

    -   They wanted to study ways needed to get students and teachers to interact with LA through designing professional development. They saw that staff wanted training on legal issues, ethical issues, using data, and training modes. Students wanted trainig to understand information and their rights. They also wanted to inform teachers with feedback and had concerns with misinterpretation of data. They created a PD design framework consisting of knowing, using and practicing, and taking action. 

5.  Finally, how, if at at, were educators in your self-selected article involved prior to wrangling and analysis?

    -   Educators and students provided study data through  interviews and completed surveys. 
...
1.  What educational issue, "problem of practice," and/or questions is addressed??
    ...
    -   How to increase understanding and engagement with learning analytics data by using learning analytics
...
2.  Briefly describe any steps of the data-intensive research workflow that can be detailed in your article or presentation.
    ...
    -   Prepare – collect interview and survey data
    -   Wrangle – organize data
    -   Explore – thematic coding, subcategory coding, focus on training and PD requirements
    -   Model – identify themes and present in order of frequency of occurrence
    -   Communicate – tables and figures with survey results paired with explanatory narrative
...
3.  How, if at all, will your article touch upon the application(s) of LA to "understand and improve learning and the contexts in which learning occurs?"
    ...
    -   The article’s focus is on improving learning and learning contexts for both understanding learning analytics and how to design a study for 
...
```{r, select-1}
# Type your code here
newsci<-select(sci_online_classes,student_id, subject, semester, FinalGradeCEMS)
head(newsci)
```
...
-   There are students that do not have a grade available for their final grade
...
```{r, filter-1}
#Type your code here
OcnAfil<- filter(sci_online_classes, subject == "OcnA")
head(OcnAfil)
```
...
```{r, arrage-1}
newsciarr<-arrange(sci_online_classes, subject, desc(percentage_earned))
view(newsciarr)
```
...
scisep<-sci_online_classes|>
    separate(course_id,
           c("subject", "semester", "section"))

finalwrangle<-scisep|>
    select(student_id, subject, semester, section, FinalGradeCEMS)|>
    filter(subject == "OcnA")|>
