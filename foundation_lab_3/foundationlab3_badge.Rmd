...
sci_classes |> 
  select(c('subject', 'Gender', 'percentage_earned', 'TimeSpent_hours')) |>
  filter(subject == "OcnA" | subject == "PhysA")

<-ggplot(sci_classes, aes(x=as.factor(percentage_earned), y=Gender)) + 
    geom_boxplot(fill="slateblue", alpha=0.2) + 
    xlab("percentage_earned")


ggplot(sci_classes, 
       aes(x = percentage_earned, 
           y = Gender,
           color = Gender)) +
  #layer 2: +  geom function type
  geom_point() +
  #layer 4: add lables
  labs(title="How Percentage Earned is Related to Gender in the Course", x="Proportion of Points Earned", y = "Gender")
```
