...
instance, to a Google Docs or Microsoft Word manuscript. Of course,
...
Make a scatterplot using the sci_classes data to examine the
relationship between - read in `sci-online-classes` save as a new object
`sci_classes` - TimeSpent_hours (i.e. hours spent online by studnets) -
and FinalGradeCEMS (i.e final course grade). - Map color to course
subject. - Set the alpha (transparency) to 0.5.
